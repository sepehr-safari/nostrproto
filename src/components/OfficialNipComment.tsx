...
interface OfficialNipCommentProps {
  comment: NostrEvent;
  nipNumber: string;
  depth?: number;
  maxDepth?: number;
...
export function OfficialNipComment({ comment, nipNumber, depth = 0, maxDepth = 3 }: OfficialNipCommentProps) {
  ...
  const { data: commentsData } = useOfficialNipComments(nipNumber);
